...
ATOM WinClass::MyRegisterClass(HINSTANCE hInstance)
{
	...
	LoadString(hInst, IDS_APP_TITLE, szTitle, MAX_LOADSTRING);//リソースから文字列取得
	...
	return RegisterClassEx(&wcex);//クラス登録
}
...
{
	hAccelTable = LoadAccelerators(hInst, MAKEINTRESOURCE(IDC_MY1));//アクセラレータ取得
